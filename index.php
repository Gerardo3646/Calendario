          ...
          <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <label for="from">Inicio Evento</label>
                    ...
                    <label for="to">Final Evento</label>
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Junta</option>
                        <option value="event-success">Evento</option>
                        <option value="event-important">Asuntos Religiosos</option>
                        <option value="event-warning">Viaje</option>
                        <option value="event-special">Pago</option>
                    </select>
                    ...
                    <label for="body">Descripción Evento</label>
                    <textarea id="body" name="event" required class="form-control" placeholder="Introduce una descripción" rows="3"></textarea>
